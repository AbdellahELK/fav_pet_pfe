...
<div class="h-60 relative">
    ...
    <h1 class=" absolute inset-0 flex items-center uppercase text-orange-500 justify-center text-4xl ">Grooming</h1>
</div>
  ...
  <div class="flex w-1/2 ">
    <div class="flex">
            ...
            <div class="container mx-auto">
                <div class="flex flex-col overflow-y-scroll py-2 space-y-2 ">
                    ...
                    <button onclick="showPhoto(0)"  class="w-20 h-20 rounded-md border-2 border-gray-300">
                        <img src="{{asset('imgs/grooming.jpg')}}"  alt="Photo 1" class="w-full h-full object-cover rounded-md hover:bg-opacity-80">
                    </button>
                    <button onclick="showPhoto(1)" class="w-20 h-20 rounded-md border-2 border-gray-300">
                        <img src="{{asset('imgs/grooming1.jpg')}}" alt="Photo 2" class="w-full h-full object-cover rounded-md">
                    </button>
                    <button onclick="showPhoto(2)" class="w-20 h-20 rounded-md border-2 border-gray-300">
                        <img src="{{asset('imgs/grooming2.jpg')}}" alt="Photo 3" class="w-full h-full object-cover rounded-md">
                    </button>
                </div>
            </div>
        </div>
        <!-- Large photo display -->
            ...
            <img id="largePhoto" src="{{asset('imgs/grooming.jpg')}}" alt="Large Photo" class="w-full h-full object-cover">
        </div>
    </div> 
    </div>
...
<div class="w-1/2" >
    <div class="bg-white shadow-md rounded-lg p-8">
        <h2 class="text-black font-bold text-2xl mb-4">Grooming</h2>
        <div class="mb-4">
            <label for="price" class="block text-gray-700 font-bold mb-2">Price:</label>
            <span class="font-bold text-lg">950 Dh - 1350 Dh</span> 
        </div>
        <div class="mb-4">
            <label for="select1" class="block text-gray-700 font-bold mb-2">Grooming Option :</label>
        ...
        <ul class="border rounded-lg divide-y divide-gray-300">
            <li>
                ...
                <div class="accordion-content hidden p-4">
                    <p class=" text-gray-600">Our grooming service offers convenience, comfort and style. We use hypoallergenic and all-natural oatmeal shampoos for a safe and luxurious experience. In-home available for an additional fee. Priced by breed and weight. By appointment only, no walk-ins.</p>
                </div>
            </li>
            <li>
                <button class="flex items-center justify-between w-full p-4 focus:outline-none" type="button"
...
<div class="m-8">
    <div class="flex space-x-1 justify-center">
      ...
      <h1 class="text-wrap font-bold text-4xl">Grooming Options</h1>  
    </div>
    ...
    <div class="container mt-10">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    <th scope="col" class="px-6 py-3 text-left text-orange-500 font-fold  tracking-wider">The Basic bath</th>
                    <th scope="col" class="px-6 py-3 text-left text-orange-500 font-fold  tracking-wider">The full Groom</th>
                </tr>
            </thead>
            <tbody class="bg-white divide-y divide-gray-200"> 
                <tr>
                    <td class="px-6 py-4 font-medium uppercase text-gray-500 whitespace-nowrap">Data 1</td>
                    <td class="px-6 py-4 font-medium uppercase text-gray-500 whitespace-nowrap">Data 2</td>
                </tr>
                <tr>
                    <td class="px-6 py-4 font-medium uppercase text-gray-500 whitespace-nowrap">Data 3</td>
                    <td class="px-6 py-4 font-medium uppercase text-gray-500 whitespace-nowrap">Data 4</td>
                </tr>
...
<script>
    function showPhoto(index) {
        ...
        const photoUrls = ['{{asset('imgs/grooming.jpg')}}', '{{asset('imgs/grooming1.jpg')}}', '{{asset('imgs/grooming2.jpg')}}'];
