...
<div class="h-60 relative">
    ...
    <h1 class=" absolute inset-0 flex items-center uppercase text-orange-500 justify-center text-4xl ">Dog Walking</h1>
</div>
  ...
  <div class="flex w-1/2 ">
    <div class="flex">
            ...
            <div class="container mx-auto">
                <div class="flex flex-col overflow-y-scroll py-2 space-y-2 ">
                    ...
                    <button onclick="showPhoto(0)"  class="w-20 h-20 rounded-md border-2 border-gray-300">
                        <img src="{{asset('imgs/dogwalking2.jpg')}}"  alt="Photo 1" class="w-full h-full object-cover rounded-md hover:bg-opacity-80">
                    </button>
                    <button onclick="showPhoto(1)" class="w-20 h-20 rounded-md border-2 border-gray-300">
                        <img src="{{asset('imgs/dogwalking1.png')}}" alt="Photo 2" class="w-full h-full object-cover rounded-md">
                    </button>
                    <button onclick="showPhoto(2)" class="w-20 h-20 rounded-md border-2 border-gray-300">
                        <img src="{{asset('imgs/dogwalking.jpg')}}" alt="Photo 3" class="w-full h-full object-cover rounded-md">
                    </button>
                </div>
            </div>
        </div>
        <!-- Large photo display -->
            ...
            <img id="largePhoto" src="{{asset('imgs/dogwalking2.jpg')}}" alt="Large Photo" class="w-full h-full object-cover">
        </div>
    </div> 
    </div>
...
<div class="w-1/2" >
    <div class="bg-white shadow-md rounded-lg p-8">
        <h2 class="text-black font-bold text-2xl mb-4">Dog walking</h2>
        <div class="mb-4">
            <label for="price" class="block text-gray-700 font-bold mb-2">Price:</label>
            <span class="font-bold text-lg">300 Dh - 500 Dh</span> 
        </div>
        <div class="mb-4">
            <label for="select1" class="block text-gray-700 font-bold mb-2">Walking Option :</label>
        ...
        <ul class="border rounded-lg divide-y divide-gray-300">
            <li>
                ...
                <div class="accordion-content hidden p-4">
                    <p class=" text-gray-600">Your pet’s well-being relies upon routine and consistency, which is why we assign your dog a designated Pet Care Specialist and pick-up window. Group walks provided for up to three dogs at a time. Private walks are subject to availability and are not offered during peak hours from 12pm – 3pm.</p>
                </div>
            </li>
            <li>
                <button class="flex items-center justify-between w-full p-4 focus:outline-none" type="button"
...
<script>
    function showPhoto(index) {
        ...
        const photoUrls = ['{{asset('imgs/dogwalking2.jpg')}}', '{{asset('imgs/dogwalking1.png')}}', '{{asset('imgs/dogwalking.jpg')}}'];
